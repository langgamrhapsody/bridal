<div class="banner">
    <div class="banner__container container">
        <div class="banner__row row">
            <div class="banner__col col-10 col-lg-8 col-xl-6">
                <div class="banner__content">
                    <h1 class="banner__content-title">About <span>Tirtha</span></h1>
                    <p class="banner__content-text">Are You looking For Professional Wedding Planners In Bali? <br> Do
                        You Need To Plan A Wedding In Bali? <br> Call Now For More Info: </p>
                    <div class="banner__socmed-button">
