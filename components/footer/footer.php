<div class="footer">
    <div class="container">
        <div class="footer__row row">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                <div class="footer__contact">
                    ...
                    <div class="footer__contact-number">
                        <a href="#" class="number-item">Mobile: +62 816 470 1020</a>
                        <a href="#" class="number-item">Tel: +62 361 847 1151</a>
                        <a href="#" class="number-item">Fax: +62 361 8471160</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-4">
                <div class="footer__socmed">
                    ...
                    <p class="footer__socmed-desc">Let's create something beautiful together!</p>
                    <div class="footer__socmed-button">
                        <a href="#" class="button-item">
                            <svg class="button-item__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path fill="currentColor" col
                                    d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                            </svg>
                        </a>
                        <a href="#" class="button-item">
                            <svg class="button-item__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div class="footer__copyright">
            <p>Copyright 2019 © <span>Tirtha Bridal.</span> All Rights Reserved</p>
        </div>
    </div>
</div>